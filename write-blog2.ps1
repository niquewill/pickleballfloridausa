...
.intro-section { max-width: 1200px; margin: 0 auto; padding: 2.5rem 2.5rem 0; }
...
/* CARD WRAPPER — holds card + archive panel side by side */
.card-wrapper { position: relative; display: flex; gap: 0; }
.blog-card { background: #fff; border-radius: 4px 0 0 4px; overflow: hidden; border: 1px solid rgba(22,50,79,0.08); transition: box-shadow 0.2s; flex: 1; min-width: 0; display: flex; flex-direction: column; }
...
/* ARCHIVE TAB — always visible strip on right edge of card */
.archive-tab { width: 36px; background: var(--navy); display: flex; align-items: center; justify-content: center; cursor: pointer; border-radius: 0 4px 4px 0; border: 1px solid rgba(255,255,255,0.1); border-left: none; flex-shrink: 0; transition: background 0.2s; position: relative; }
...
.sheet-item:active { background: #fdf8f2; }
...
/* mobile archive button inside card */
...
<div class="intro-section">
  <p>The Coastal Circle Chronicles follows four real women living, playing, and gossiping their way through Florida's most vibrant pickleball communities. New dispatches published weekly.</p>
</div>
...
<div class="bottom-sheet" id="bottomSheet">
  ...
  <div class="sheet-header">
    <p id="sheetTitle">Past Dispatches</p>
  ...
  <div class="blog-grid">
    ...
    <div class="card-wrapper" id="wrapper-patrice">
      <div class="blog-card" id="card-patrice">
        ...
        <div class="blog-card-body" id="body-patrice">
        ...
        <button class="mobile-archive-btn" onclick="openSheet('patrice')">Past Dispatches <span>&#8250;</span></button>
      </div>
    ...
    <div class="card-wrapper" id="wrapper-nicolette">
      <div class="blog-card" id="card-nicolette">
        ...
        <div class="blog-card-body" id="body-nicolette">
        ...
        <button class="mobile-archive-btn" onclick="openSheet('nicolette')">Past Dispatches <span>&#8250;</span></button>
      </div>
    ...
    <div class="card-wrapper" id="wrapper-vivian">
      <div class="blog-card" id="card-vivian">
        ...
        <div class="blog-card-body" id="body-vivian">
        ...
        <button class="mobile-archive-btn" onclick="openSheet('vivian')">Past Dispatches <span>&#8250;</span></button>
      </div>
    ...
    <div class="card-wrapper" id="wrapper-stella">
      <div class="blog-card" id="card-stella">
        ...
        <div class="blog-card-body" id="body-stella">
        ...
        <button class="mobile-archive-btn" onclick="openSheet('stella')">Past Dispatches <span>&#8250;</span></button>
      </div>
...
var archiveData = {
  patrice: {
    current: {
      title: "The Week Bunny Served Straight Into Lady Ashford's Hermes",
      text: "<p>Darlings, where do I even BEGIN with this week? Monday morning at Phipps was absolutely electric and I am not just talking about the humidity that required three touch-ups of my Chantecaille foundation by noon. Bunny and I were paired against the Ashford twins and during the most crucial point of the third game, Bunny executed what can only be described as a demonic serve that ricocheted off the net and somehow ended up lodging itself in Lady Ashford's Kelly bag courtside. The silence. The DRAMA.</p><p>Wednesday I finally debuted my Coastal Court Tote paired with my new Loro Piana tennis whites. Even Mitzi Caldwell asked where I got it during our cooldown at The Bath and Tennis Club.</p>"
    },
    posts: [
      { date: "May 26", title: "The Courts Are Back and So Are We", text: "<p>The Phipps Ocean Park courts got resurfaced and Bunny called me before my coffee was even finished to deliver this news like it was a stock tip. By nine o'clock we were out there and I will say the new surface is extraordinary. I wore my new Loro Piana sun hat and not a single person commented on it, which tells me everything I need to know about where we are culturally.</p><p>Bunny and I grabbed lunch at Ta-boo after and she told me in complete confidence that the couple who used to dominate the Tuesday round robin at Bath and Tennis have apparently switched to tennis. I said a prayer for them and ordered the crab salad.</p>" },
      { date: "May 12", title: "Geoffrey Finally Watched a Full Match and Had Opinions", text: "<p>Against all reasonable expectations, Geoffrey sat through our entire Tuesday round robin at Phipps and afterward declared that pickleball was more strategic than it looks. I have been saying this for three years. Bunny and I were too stunned to respond. He has since purchased a paddle. We are monitoring the situation closely.</p><p>Margaux called from the city that evening to ask how my game was going and I told her Geoffrey had bought a paddle and there was a very long silence on the line before she said she would pray for us both. I found that unnecessarily dramatic.</p>" },
      { date: "Apr 28", title: "The Charity Tournament at The Breakers", text: "<p>The annual spring charity tournament at The Breakers was as always an exercise in Palm Beach doing Palm Beach things. Everyone was very competitive and also wearing something from Net-a-Porter or a small Italian brand you have never heard of. Bunny and I made it to the semifinals. I am choosing to be proud of that.</p><p>Geoffrey attended for the first time and spent most of the afternoon talking to a former hedge fund manager from Greenwich about court surfaces. I am choosing to be proud of that too.</p>" },
      { date: "Apr 14", title: "Carlos Says I Need More Spin. Carlos Is Not Wrong.", text: "<p>My trainer Carlos has crossed fully from fitness advisor into pickleball coach and I have mixed feelings. On one hand he has genuinely improved my third shot drop. On the other hand he now has opinions about my grip and expressed them in front of Margaux who was visiting from the city and who will absolutely never let me forget it.</p><p>I did finally cave and try the paddle he recommended and I will admit to nothing publicly except that my backhand has improved considerably and Bunny noticed immediately which is the only metric that matters.</p>" }
    ]
  },
  nicolette: {
    current: {
      title: "Court Drama, Crosscourt Dreams, and the Creamiest Burrata I Have Had All Month",
      text: "<p>Honestly this week has been an absolute whirlwind of pickleball and pure Naples magic. Tuesday morning started with the most glorious sunrise session at Naples Grande. Thomas had me working on my third shot drops until my legs were absolutely screaming but I cannot even complain because afterwards Camille and I treated ourselves to lunch at The French on Fifth. The burrata with heirloom tomatoes was life-changing.</p><p>Derek joined us for mixed doubles on Thursday and I wore my new Pickleball Florida USA moisture-wicking dress. We grabbed Rosie afterward and walked through Venetian Village where she charmed every single person on the sidewalk.</p>"
    },
    posts: [
      { date: "May 25", title: "Derek Found His People and I Found a New Restaurant", text: "<p>Derek came home, looked up three YouTube videos on the third shot drop, and asked me if we could hit some balls before dinner. We have been married twenty-two years and this man has never once suggested physical activity before dinner. We went to Pelican Bay and honestly he is not terrible. Camille saw us from across the court and gave me a thumbs up which I chose to interpret as encouragement.</p><p>After we stopped at The French on Fifth for a glass of rose and I need to tell you about their new small plates menu because it is absolutely worth the parking situation on Fifth Avenue.</p>" },
      { date: "May 11", title: "Thomas Told Me I Am Ready for the 3.5 Tournament", text: "<p>Thursday lesson with Thomas ended with him saying very casually that he thought I was ready to enter the 3.5 bracket at Naples Grande next month. I smiled and said thank you and then called Camille from the parking lot of Seed to Table and had a complete meltdown which she handled beautifully by immediately suggesting dinner at Mediterrano.</p><p>Derek thinks I should do it. Rosie is neutral. I am still deciding but I did look up the registration deadline and it is sooner than I would like.</p>" },
      { date: "Apr 27", title: "The Snowbird Exodus and What It Does to Court Availability", text: "<p>It is officially post-season in Naples which means the snowbirds have returned north and suddenly we have actual court time before 10am again. Camille and I celebrated by booking Pelican Bay for Tuesday and Thursday morning for the next six weeks. Rosie is thrilled. The humidity is less thrilling but we are managing.</p><p>Derek asked if he could come to the Thursday session. We said yes but only to the Thursday session and only if he stops calling every third shot drop a dink.</p>" },
      { date: "Apr 13", title: "Camille Won the Round Robin and I Made Peace With It", text: "<p>Camille won the Naples Grande monthly round robin and I am genuinely completely one hundred percent happy for her. I am also switching to a heavier paddle next week because clearly something needs to change and it is not my attitude.</p><p>We celebrated at Vanderbilt Beach and the sunset was so beautiful that I briefly forgot I lost in the quarterfinals. Rosie ran into the waves approximately eleven times. Derek ordered something called a loaded nacho situation from a food truck and I chose not to comment on it.</p>" }
    ]
  },
  vivian: {
    current: {
      title: "Kenny Called a Foot Fault on Dottie. Now We Are in a Cold War.",
      text: "<p>Listen, I have been playing pickleball in this retirement paradise for three years now and I thought I had seen everything. But this week Kenny called a foot fault on Dottie during our Tuesday morning game. Honey, you could have heard a pin drop across all of Lake Sumter Landing. Dottie is from Jersey. She does not forget and she does not forgive. Now she has got me driving our golf cart the long way to courts just to avoid passing his driveway.</p><p>The rest of the week was actually pretty great. I finally broke down and ordered one of those Pickleball Florida USA paddle covers and honey it has been a practical delight. Thursday we played at Tierra Del Sol and celebrated with Key lime pie from Katie Belle's.</p>"
    },
    posts: [
      { date: "May 24", title: "Kenny Moved Up a Level and Now It Is Personal", text: "<p>Kenny self-rated to 4.0 and signed up for the advanced round robin on Wednesday mornings. Frank found out from Dottie who found out from the sign-up sheet and called me while I was in the Publix on Rolling Acres. I had to put down my cantaloupe. The advanced group over there includes Barbara who played in nationals last year and two brothers from New Jersey who are absolutely no joke.</p><p>Dottie and I watched from the bleachers with our coffee and I want to be very clear that we were there to be supportive. We were completely supportive. We only laughed twice.</p>" },
      { date: "May 10", title: "The Knudson Morning Crew Gets a New Member", text: "<p>A new couple moved into Buttonwood neighborhood last week and showed up at Knudson Tuesday morning with matching outfits and brand new Selkirk paddles still in the packaging. Dottie said bless their hearts in that way she has that means something very different. They were actually quite good. We have revised our opinions. They have been invited to Saturday coffee at Lake Sumter Landing.</p><p>Frank thinks the husband might have played tennis competitively at some point. The way he moves at the kitchen line is suspicious in the best possible way.</p>" },
      { date: "Apr 26", title: "Frank Wants to Enter a Tournament and I Have Questions", text: "<p>Frank came home from his 7am game on Thursday and announced he wants to enter the senior men's doubles tournament at Hacienda Hills next month. I said Frank you have been playing for eight months. He said Vivian I have been practicing. These are two different things and I said so.</p><p>Dottie says we should let him enter and watch from the bleachers with coffee. This is why she is my best friend. Frank has already called his partner Gary and Gary is apparently in. Gary has been playing for six months. Lord help us all.</p>" },
      { date: "Apr 12", title: "Marge Came to Watch and Now She Wants to Play", text: "<p>In thirty-seven years of knowing Marge I have never seen her express interest in a sport of any kind. She came to watch our Tuesday game at Knudson because she had nothing else to do and her book club got cancelled. Forty-five minutes later she asked if there was a beginner clinic.</p><p>I am still processing this. Dottie says we created a monster. I think we created a teammate. Frank is already offering to teach her his serve which is generous considering his serve needs some work itself but that is marriage for you.</p>" }
    ]
  },
  stella: {
    current: {
      title: "The Week I Played Through a Meltdown Mine Not Marco's For Once",
      text: "<p>Here is the thing. I thought moving to Sarasota would mellow me out. Six years later I am standing at Pompano Park on Tuesday morning having what can only be described as a graphic designer's existential crisis over paddle grip colors while Diane patiently waits for me to serve. Last month I lectured everyone for fifteen minutes about kerning after someone made a tournament flyer in Papyrus. PAPYRUS.</p><p>Monday at Urfer was brutal. Marco came along and proceeded to hit perfect third-shot drops while I shanked balls into the next county. Then Wednesday happened and Diane and I absolutely demolished a doubles match at Bay Front. We stopped at Piccolo Italian Market after because winning requires prosciutto. It is science.</p>"
    },
    posts: [
      { date: "May 23", title: "The Tuesday Crew Survives Another Florida Summer", text: "<p>Here is the thing about playing pickleball in Sarasota in May. You either commit fully or you move somewhere with a functioning atmosphere. The Tuesday crew showed up to Pompano at seven thirty and by eight fifteen Gabi had already declared it too hot to be legal. Marco wore a hat for the first time in his life because I threatened consequences and I have to say it looked genuinely good on him which I told him and then immediately regretted.</p><p>I finally caved and got the JOOLA Ben Johns paddle that Diane has been quietly evangelizing about for three months and I owe her a full apology because it is extraordinary.</p>" },
      { date: "May 9", title: "Gabi Talked Me Into a 6am Game and I Am Still Not Over It", text: "<p>Gabi texted at 10pm to ask if I wanted to beat the heat with a 6am session at Urfer. I said yes because I am weak and she is persuasive. We got there and the courts were still damp. Marco somehow materialized at 6:05 with coffee which is the only reason I forgave him for being annoyingly good at a sport he claims not to care about.</p><p>We played until 8 and got breakfast sandwiches at a place on Fruitville I cannot believe I have been sleeping on. Gabi found it by asking her phone for the nearest place that opened before 7am and sometimes that is all the research you need.</p>" },
      { date: "Apr 25", title: "I Entered a Tournament and Told No One Until Afterward", text: "<p>I entered the Urfer Family Park spring tournament under the reasoning that if I did not tell anyone and I lost badly it would be like it never happened. I did not lose badly. I made it to the final in my bracket and lost in three games to a woman named Carol from Bradenton who was sixty-one years old and absolutely merciless at the net. I respect her completely.</p><p>I told Diane first. She was annoyingly calm about it. Marco sent three fire emojis. Gabi sent seventeen. This tracks perfectly for both of them.</p>" },
      { date: "Apr 11", title: "Diane Has Been Right About Everything and I Am Formally Acknowledging It", text: "<p>A partial list of things Diane has been right about that I initially dismissed includes the JOOLA paddle, the ASICS court shoes over my old Nikes, the value of arriving ten minutes early to warm up properly, and Piccolo Italian Market on Laurel. I am a graphic designer with strong opinions and a long history of being wrong about things that Diane is quietly correct about.</p><p>This is my formal acknowledgment. She will not make a big deal of it. That is why she is my doubles partner and also why I will probably ignore her next recommendation for at least two months before eventually admitting she was right again.</p>" }
    ]
  }
};
...
function loadPost(persona, index) {
  ...
  var items = document.querySelectorAll('#list-' + persona + ' .archive-item');
  items.forEach(function(el, i) { el.classList.toggle('active', i === index); });
  var sheetItems = document.querySelectorAll('#sheetList .sheet-item');
  sheetItems.forEach(function(el, i) { el.classList.toggle('active', i === index); });
}
...
var activeSheetPersona = null;
function openSheet(persona) {
  activeSheetPersona = persona;
  var data = archiveData[persona];
  document.getElementById('sheetTitle').textContent = persona.charAt(0).toUpperCase() + persona.slice(1) + "'s Past Dispatches";
...
Write-Host "blog.html written!" -ForegroundColor Green
Write-Host "Now run:" -ForegroundColor Cyan
Write-Host "  git add pages/blog.html" -ForegroundColor Yellow
Write-Host "  git commit -m 'Archive panel with side expand and mobile sheet'" -ForegroundColor Yellow
